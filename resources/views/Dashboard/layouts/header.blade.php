            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index.html" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="https://cdn3d.iconscout.com/3d/free/thumb/google-5148287-4299203.png" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="https://cdn3d.iconscout.com/3d/free/thumb/google-5148287-4299203.png" alt="" height="17">
                        </span>
                    </a>
            ...
            <div class="d-flex align-items-center  ">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="{{ route('user.edit',\Illuminate\Support\Facades\Auth::id()) }}"><i
                        ...
                        <form class="dropdown-item  " method="post" action="{{ route('logout') }}" style="cursor: pointer">
                            ...
                            <button class="align-middle btn text-danger p-0 fw-bolder " data-key="t-logout" type="submit">
                                Logout
                            </button>
                        </form>
