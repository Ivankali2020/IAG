...
@section('search')
    <!-- App Search-->
    <form class="app-search d-none d-md-block" action="{{ route('subCategory.create') }}" method="get">
...
@endsection
@section('subCategory_create','active')
            ...
            <div class="col-xxl-12 ">
                <div class="card">
                    <div class="card-header align-items-center d-flex" data-aos="fade-up">
                        <h4 class="card-title mb-0 flex-grow-1"  >SubCategory List</h4>
                        <div class="flex-shrink-0">

                            <!-- Default Modals -->
                            <button type="button" class="btn btn-success  " data-bs-toggle="modal" data-bs-target="#myModal">+ Create SubCategory</button>
                                    ...
                                    @forelse($subCategories as $subCategory)
                                        <tr >
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-danger btn-sm " onclick="confirm('{{ $subCategory->name }}','{{ $subCategory->id }}')">
                                                    <i class='bx bx-trash'></i>
                                                </button>
                                                <form action="{{ route('subCategory.destroy',$subCategory->id) }}" id="BrandDel{{ $subCategory->id }}" method="post">
                                                    @csrf @method("DELETE")
                                                </form>
                                            </td>
...
@section('script')
    ...
    <script>
        ...
        function confirm(value,id){
            Swal.fire({
                title: "Are you sure?",
                text: ` ${value} subCategory will be delete!`,
                icon: "warning",
                showCancelButton: !0,
